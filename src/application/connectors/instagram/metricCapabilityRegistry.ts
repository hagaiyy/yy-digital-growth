...
export const INSTAGRAM_METRIC_CAPABILITY_REGISTRY: MetricCapabilityEntry[] = [
  ...
  media({
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Documented FEED/REELS metric, never requested against real content yet.",
  }),
  media({
    contentType: "reel",
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Not found in current Meta Instagram media-insights documentation (v25.0) — may be an older/renamed metric name; included per task candidate list.",
  }),
  media({
    contentType: "reel",
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Not found in current Meta documentation (v25.0) — likely superseded by ig_reels_video_view_total_time; included per task candidate list.",
  }),
  media({
    contentType: "reel",
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Meta documents this as an estimated, in-development metric.",
  }),
  media({
    contentType: "reel",
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Documented Reel metric ('total plays on Facebook'); never requested against real content yet.",
  }),
  media({
    contentType: "reel",
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Meta documents this as throwing an error unless the Reel was actually crossposted to Facebook.",
  }),
  ...
  media({
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Confirmed supported for carousel content on the same account; not yet independently confirmed for a plain image post.",
  }),
  media({
    contentType: "imagePost",
    providerMetric: "profile_activity",
  ...
  media({
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Documented FEED metric, never requested against real content yet.",
  }),
  media({
    contentType: "imagePost",
    providerMetric: "impressions",
  ...
  media({
    ...
    status: "untested",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Documented FEED metric, never requested against real carousel content yet.",
  }),
  media({
    contentType: "carousel",
    providerMetric: "impressions",
  ...
  // ---------------------------------------------------------------
  // Account-level — never implemented before this task. Every
  // candidate is untested until Part 9's live production run.
  // ---------------------------------------------------------------
  account({ providerMetric: "reach", internalMetric: "reach", nativeUnit: "count", status: "untested", period: "day", lastVerifiedDate: LIVE_2026_08_01 }),
  account({ providerMetric: "views", internalMetric: "views", nativeUnit: "count", status: "untested", period: "day", lastVerifiedDate: LIVE_2026_08_01 }),
  account({
  ...
  account({ providerMetric: "profile_links_taps", internalMetric: "profileLinksTaps", nativeUnit: "count", status: "untested", period: "day", breakdown: "contact_button_type", lastVerifiedDate: LIVE_2026_08_01 }),
  account({
    ...
    period: "day",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Meta documents this as unavailable for accounts with fewer than 100 followers.",
  }),
  account({
    ...
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Meta documents this as requiring 100+ followers.",
  }),
  account({ providerMetric: "accounts_engaged", internalMetric: "accountsEngaged", nativeUnit: "count", status: "untested", period: "day", lastVerifiedDate: LIVE_2026_08_01 }),
  account({ providerMetric: "total_interactions", internalMetric: "engagements", nativeUnit: "count", status: "untested", period: "day", breakdown: "media_product_type", lastVerifiedDate: LIVE_2026_08_01 }),
  account({ providerMetric: "likes", internalMetric: "likes", nativeUnit: "count", status: "untested", period: "day", breakdown: "media_product_type", lastVerifiedDate: LIVE_2026_08_01 }),
  account({ providerMetric: "comments", internalMetric: "comments", nativeUnit: "count", status: "untested", period: "day", breakdown: "media_product_type", lastVerifiedDate: LIVE_2026_08_01 }),
  account({ providerMetric: "shares", internalMetric: "shares", nativeUnit: "count", status: "untested", period: "day", breakdown: "media_product_type", lastVerifiedDate: LIVE_2026_08_01 }),
  account({ providerMetric: "saves", internalMetric: "saves", nativeUnit: "count", status: "untested", period: "day", breakdown: "media_product_type", lastVerifiedDate: LIVE_2026_08_01 }),
  account({ providerMetric: "replies", internalMetric: "replies", nativeUnit: "count", status: "untested", period: "day", lastVerifiedDate: LIVE_2026_08_01 }),
  account({
    ...
    period: "day",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Not found in current Meta account-insights documentation (v25.0) — may be deprecated or renamed; included per task candidate list.",
  }),
  account({
    ...
    period: "lifetime",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Meta documents this as only reflecting the last 30 days, regardless of requested range.",
  }),
  account({
    ...
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Meta documents this as unavailable below 100 followers, and returns an empty (not error) result in that case.",
  }),
  account({
    ...
    timeframe: "this_month",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Meta documents this as unavailable below 100 engagements, and returns an empty (not error) result in that case.",
  }),
  account({
    ...
    timeframe: "this_month",
    lastVerifiedDate: LIVE_2026_08_01,
    safeLimitation: "Not found in current Meta account-insights documentation (v25.0) — may be deprecated or merged into follower/engaged demographics; included per task candidate list.",
  }),
];
